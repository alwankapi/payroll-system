            ...
            @if(auth()->user()->role === 'karyawan')
                ...
                <li>
                    <a href="{{ route('karyawan.dashboard') }}" 
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->routeIs('karyawan.dashboard') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white {{ request()->routeIs('karyawan.dashboard') ? 'text-gray-900 dark:text-white' : '' }}" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li>
                    <a href="{{ route('karyawan.profil.index') }}" 
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->routeIs('karyawan.profil.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                ...
                <li>
                    <a href="{{ route('karyawan.riwayat-gaji.index') }}" 
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->routeIs('karyawan.riwayat-gaji.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li>
                    <a href="{{ route('karyawan.password.edit') }}" 
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->routeIs('karyawan.password.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            @else
                ...
                <li>
                    <a href="{{ route('dashboard') }}" 
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white {{ request()->routeIs('dashboard') ? 'text-gray-900 dark:text-white' : '' }}" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                            <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                        </svg>
                        <span class="ml-3">Dashboard</span>
                ...
                <li x-data="{ open: {{ request()->is('jabatan*') || request()->is('karyawan*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" type="button" 
                        ...
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <ul x-show="open" x-transition class="py-2 space-y-2">
                        ...
                        <li>
                            <a href="{{ route('karyawan.index') }}" 
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->routeIs('karyawan.*') && !request()->routeIs('karyawan.dashboard') && !request()->routeIs('karyawan.profil.*') && !request()->routeIs('karyawan.riwayat-gaji.*') && !request()->routeIs('karyawan.password.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li x-data="{ open: {{ request()->is('penggajian*') || request()->is('potongan*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" type="button" 
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20">
